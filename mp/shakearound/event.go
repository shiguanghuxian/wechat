...
// 和 github.com/shiguanghuxian/wechat/v2/mp/core.MixedMsg.ChosenBeacon 一样, 同步修改
...
// 和 github.com/shiguanghuxian/wechat/v2/mp/core.MixedMsg.AroundBeacon 一样, 同步修改
